      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="bg-card/70 backdrop-blur border-slate-800">
          ...
          <CardContent className="space-y-4">
            ...
            <Field label="Email" type="email" value={localSettings.email} onChange={(v) => handleChange('email', v)} placeholder="contact@kilimo.cm" icon={Mail} />
            <Field label="Site Web" type="url" value={localSettings.websiteUrl} onChange={(v) => handleChange('websiteUrl', v)} placeholder="https://www.kilimo.cm" icon={Globe} />
          </CardContent>
        </Card>
